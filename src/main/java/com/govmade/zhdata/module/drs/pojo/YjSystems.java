...
public class YjSystems extends BasePo<YjSystems> {
	...
	private Double ndywje;
	
	private String ywzjly;
	
	private Integer ywfs;
	
	private String xtlb;
	
	private String sjzzqk;
	...
	private String zhzhyy;
	
	private Integer sjxq;
	
	private String sjxqsm;
	...
	private Integer xxhjgrybzqk;
	
	private Integer xxhryjszc;
	
	private Integer cdxxhgzdsydw;
	
	private Integer cdxxhgzdnsjg;
	
	private Integer xtqk;
	
	private Integer xtjg;
	
	private String xxlrfs;
	
	private String xtxxck;
	
	private String rjjgms;
	
	private String sjkppbbyxpt;
	
	private String sjccfs;
	
	private Integer sjwjdx;
	
	private String sjjmfs;
	
	private Integer jszl;
	
	private String sjgxms;
	
	private String wbbs;
	
	private String bssx;
	
	private String jfcdmj;
	
	private String jgsl;
	
	private String bjddyrl;
	
	private String zyhtgjgsl;
	
	private String tgzngyysjf;
	
	private Integer jfjmkt;
	
	private Integer jfzhjkxt;
	
	private String nbjywzds;
	
	private String czywxtsl;
	
	private String dzzwwwzds;
	
	private String zwzds;
	
	private String zwczywxtsl;
	
	private Integer zwljfw;
	
	private Integer yqtwlljqk;
	
	private String cc;
	
	private String nkdsyf;
	
	
	
	private String pcfwqppsl;
	
	private String czxtlxsl;
	
	private String xxjppsl;
	
	private String bfsbsl;
	
	private String wlsbsl;
	
	private String zjjlxhsl;
    ...
    public Double getNdywje() {
        return ndywje;
    }

    public void setNdywje(Double ndywje) {
        this.ndywje = ndywje;
    }

    public String getYwzjly() {
        return ywzjly;
    }

    public void setYwzjly(String ywzjly) {
        this.ywzjly = ywzjly;
    }
    ...
    public String getYjrwllx() {
        return yjrwllx;
    }

    public void setYjrwllx(String yjrwllx) {
        this.yjrwllx = yjrwllx;
    }
    ...
    public String getZhzhyy() {
        return zhzhyy;
    }

    public void setZhzhyy(String zhzhyy) {
        this.zhzhyy = zhzhyy;
    }

    public Integer getSjxq() {
        return sjxq;
    }

    public void setSjxq(Integer sjxq) {
        this.sjxq = sjxq;
    }

    public String getSjxqsm() {
        return sjxqsm;
    }


	public void setSjxqsm(String sjxqsm) {
		this.sjxqsm = sjxqsm;	
	}

	public String getSjzzqk() {
		return sjzzqk;
	}

	public void setSjzzqk(String sjzzqk) {
		this.sjzzqk = sjzzqk;
	}
	...
	public Integer getXxhjgrybzqk() {
		return xxhjgrybzqk;
	}

	public void setXxhjgrybzqk(Integer xxhjgrybzqk) {
		this.xxhjgrybzqk = xxhjgrybzqk;
	}

	public Integer getXxhryjszc() {
		return xxhryjszc;
	}

	public void setXxhryjszc(Integer xxhryjszc) {
		this.xxhryjszc = xxhryjszc;
	}

	public Integer getCdxxhgzdsydw() {
		return cdxxhgzdsydw;
	}

	public void setCdxxhgzdsydw(Integer cdxxhgzdsydw) {
		this.cdxxhgzdsydw = cdxxhgzdsydw;
	}

	public Integer getCdxxhgzdnsjg() {
		return cdxxhgzdnsjg;
	}

	public void setCdxxhgzdnsjg(Integer cdxxhgzdnsjg) {
		this.cdxxhgzdnsjg = cdxxhgzdnsjg;
	}

	public Integer getXtqk() {
		return xtqk;
	}

	public void setXtqk(Integer xtqk) {
		this.xtqk = xtqk;
	}
	...
	public String getXtxxck() {
		return xtxxck;
	}

	public void setXtxxck(String xtxxck) {
		this.xtxxck = xtxxck;
	}

	public String getRjjgms() {
		return rjjgms;
	}

	public void setRjjgms(String rjjgms) {
		this.rjjgms = rjjgms;
	}

	public String getSjkppbbyxpt() {
		return sjkppbbyxpt;
	}

	public void setSjkppbbyxpt(String sjkppbbyxpt) {
		this.sjkppbbyxpt = sjkppbbyxpt;
	}

	public String getSjccfs() {
		return sjccfs;
	}

	public void setSjccfs(String sjccfs) {
		this.sjccfs = sjccfs;
	}
	...
	public String getSjjmfs() {
		return sjjmfs;
	}

	public void setSjjmfs(String sjjmfs) {
		this.sjjmfs = sjjmfs;
	}
	...
	public String getSjgxms() {
		return sjgxms;
	}

	public void setSjgxms(String sjgxms) {
		this.sjgxms = sjgxms;
	}
	...
	public String getBssx() {
		return bssx;
	}

	public void setBssx(String bssx) {
		this.bssx = bssx;
	}

	public String getJfcdmj() {
		return jfcdmj;
	}

	public void setJfcdmj(String jfcdmj) {
		this.jfcdmj = jfcdmj;
	}
	...
	public String getBjddyrl() {
		return bjddyrl;
	}

	public void setBjddyrl(String bjddyrl) {
		this.bjddyrl = bjddyrl;
	}

	public String getZyhtgjgsl() {
		return zyhtgjgsl;
	}

	public void setZyhtgjgsl(String zyhtgjgsl) {
		this.zyhtgjgsl = zyhtgjgsl;
	}

	public String getTgzngyysjf() {
		return tgzngyysjf;
	}

	public void setTgzngyysjf(String tgzngyysjf) {
		this.tgzngyysjf = tgzngyysjf;
	}

	public Integer getJfjmkt() {
		return jfjmkt;
	}

	public void setJfjmkt(Integer jfjmkt) {
		this.jfjmkt = jfjmkt;
	}

	public Integer getJfzhjkxt() {
		return jfzhjkxt;
	}

	public void setJfzhjkxt(Integer jfzhjkxt) {
		this.jfzhjkxt = jfzhjkxt;
	}

	public String getNbjywzds() {
		return nbjywzds;
	}

	public void setNbjywzds(String nbjywzds) {
		this.nbjywzds = nbjywzds;
	}

	public String getCzywxtsl() {
		return czywxtsl;
	}

	public void setCzywxtsl(String czywxtsl) {
		this.czywxtsl = czywxtsl;
	}

	public String getDzzwwwzds() {
		return dzzwwwzds;
	}

	public void setDzzwwwzds(String dzzwwwzds) {
		this.dzzwwwzds = dzzwwwzds;
	}

	public String getZwzds() {
		return zwzds;
	}

	public void setZwzds(String zwzds) {
		this.zwzds = zwzds;
	}

	public String getZwczywxtsl() {
		return zwczywxtsl;
	}

	public void setZwczywxtsl(String zwczywxtsl) {
		this.zwczywxtsl = zwczywxtsl;
	}

	public Integer getZwljfw() {
		return zwljfw;
	}

	public void setZwljfw(Integer zwljfw) {
		this.zwljfw = zwljfw;
	}

	public Integer getYqtwlljqk() {
		return yqtwlljqk;
	}

	public void setYqtwlljqk(Integer yqtwlljqk) {
		this.yqtwlljqk = yqtwlljqk;
	}
	...
	public String getNkdsyf() {
		return nkdsyf;
	}

	public void setNkdsyf(String nkdsyf) {
		this.nkdsyf = nkdsyf;
	}

	public String getPcfwqppsl() {
		return pcfwqppsl;
	}

	public void setPcfwqppsl(String pcfwqppsl) {
		this.pcfwqppsl = pcfwqppsl;
	}

	public String getCzxtlxsl() {
		return czxtlxsl;
	}

	public void setCzxtlxsl(String czxtlxsl) {
		this.czxtlxsl = czxtlxsl;
	}

	public String getXxjppsl() {
		return xxjppsl;
	}

	public void setXxjppsl(String xxjppsl) {
		this.xxjppsl = xxjppsl;
	}

	public String getBfsbsl() {
		return bfsbsl;
	}

	public void setBfsbsl(String bfsbsl) {
		this.bfsbsl = bfsbsl;
	}

	public String getWlsbsl() {
		return wlsbsl;
	}

	public void setWlsbsl(String wlsbsl) {
		this.wlsbsl = wlsbsl;
	}

	public String getZjjlxhsl() {
		return zjjlxhsl;
	}

	public void setZjjlxhsl(String zjjlxhsl) {
		this.zjjlxhsl = zjjlxhsl;
	}

	public String getCcrl() {
		return ccrl;
	}

	public void setCcrl(String ccrl) {
		this.ccrl = ccrl;
	}
	...
	public String getSjbfpl() {
		return sjbfpl;
	}

	public void setSjbfpl(String sjbfpl) {
		this.sjbfpl = sjbfpl;
	}
