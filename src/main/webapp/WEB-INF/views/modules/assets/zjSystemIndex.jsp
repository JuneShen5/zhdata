    ...
    <body class="white-bg">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                <div class="text-center">
                                    ...
                                    <button class="btn btn-purple" type="button" onclick="importData(5);"><i class='fa fa-sign-in'></i> Excel导入</button>
        ...
        <div id="layer_form" style="display: none" class="ibox-content" >
            <form role="form" id="mainForm" class="form-horizontal main-form">
                ...
                <!-- 基本信息 -->
                <%@include file="/WEB-INF/views/modules/assets/systemTable/zj_baseInfo.jsp"%>
                <!-- 项目建设状态 -->
                <%@include file="/WEB-INF/views/modules/assets/systemTable/zj_statusInfo.jsp"%>
                <!-- 项目建设必要性说明 -->
                <%@include file="/WEB-INF/views/modules/assets/systemTable/zj_necessaryInfo.jsp"%>
                <!-- 系统整合信息 -->
                <%@include file="/WEB-INF/views/modules/assets/systemTable/zj_systemInfo.jsp"%>
                <!-- 备注与说明 -->
