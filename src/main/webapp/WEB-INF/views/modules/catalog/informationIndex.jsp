...
<body class="white-bg skin-7">
	...
	<div id="element_layer_form" style="display:none" class="ibox-content">
			...
			<%-- <input type="text" name="dict" class="hide" id="dictId">
			<div class="form-group">
				<label class="col-sm-3 control-label">开放属性：</label>
				<div class="col-sm-7">
					<c:forEach var="dict" items="${fns:getDictList('open_type')}">
						<label class="radio-inline i-checks">
							<input type="radio" value="${dict.value}" name="openType">  ${dict.label}</label>
					</c:forEach>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<c:forEach var="dict" items="${fns:getDictList('share_type')}">
						<label class="radio-inline i-checks">
							<input type="radio" value="${dict.value}" name="shareType">  ${dict.label}</label>
					</c:forEach>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-7">
					<c:forEach var="dict" items="${fns:getDictList('yes_no')}">
						<label class="radio-inline i-checks">
							<input type="radio" value="${dict.value}" name="isShow">  ${dict.label}</label>
					</c:forEach>
				</div>
			</div> --%> 
			<!-- <div class="form-group">
