...
! function (a) {
    ...
    a.extend(a.validator.messages, {
        ...
        roleRequired: icon + "请选择至少一个角色授权！",
        zipCode: icon + "请输入正确的邮编",
        mobilePhone: icon + "请输入正确的手机号码",
        eleDict: icon + "请输入正确的字典",
        idcard: icon + "请输入正确的身份证",
        webname: icon + "请输入正确的域名",
        qq: icon + "请输入正确的QQ号",
        telephone: icon + "请输入正确的国内电话",
        nochar: icon + "不能使用汉字或者特殊字段"
    })
});
